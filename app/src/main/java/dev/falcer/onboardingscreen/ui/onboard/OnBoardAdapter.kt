...
class OnBoardAdapter : RecyclerView.Adapter<OnBoardAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.card_on_board, parent, false))
    }
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(data: OnBoard) {
            Glide.with(itemView).load(data.image).fitCenter().into(image)
